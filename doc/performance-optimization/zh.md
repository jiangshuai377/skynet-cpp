...
- 父级最佳实践项目中的 perf benchmark runner
- 父级最佳实践项目中的 Linux/native comparison runner

perf runner 有意放在 runtime 仓库外侧，避免 runtime 树被完整覆盖率、性能、
Docker 和离线工具链压重。
...
从父级 `testa/` 最佳实践项目运行 Linux full perf runner：
